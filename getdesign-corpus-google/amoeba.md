...
version: alpha
name: "Amoeba Music"
description: "Hi-vis sticker yellow on black, LasVegasOTJackpot display, dotted underlines and 6px chunky sleeve corners."
...
typography:
  display-hero:
    fontFamily: "LasVegasOTJackpot, ui-sans-serif, system-ui, sans-serif"
    fontSize: 72px
    fontWeight: 400
    lineHeight: 1.05
    letterSpacing: -1px
