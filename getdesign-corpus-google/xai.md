...
version: alpha
name: "xAI"
description: "Monochrome by design — Universal Sans 80px tight, GeistMono uppercase 14px, 9999px pill buttons on near-black `#1f2228`."
...
typography:
  display-hero:
    fontFamily: "Universal Sans, ui-sans-serif, system-ui, sans-serif"
    fontSize: 80px
    fontWeight: 400
    lineHeight: 1.05
    letterSpacing: -1px
