...
version: alpha
name: "Braun"
description: "Dieter Rams restraint made digital — jet-black canvas, pill CTAs, and a single teal accent that earns every pixel"
...
typography:
  display-hero:
    fontFamily: "Braun Linear, ui-sans-serif, system-ui, sans-serif"
    fontSize: 48px
    fontWeight: 400
    lineHeight: 1.05
    letterSpacing: -1px
