...
description: "Gunmetal black canvas, uppercase DIN, and a single crimson accent that signals speed without apology"
...
typography:
  display-hero:
    fontFamily: "DIN2014-Demi, ui-sans-serif, system-ui, sans-serif"
    fontSize: 80px
    fontWeight: 400
    lineHeight: 1.05
    letterSpacing: -1px
...
# Triumph Motorcycles Design System
