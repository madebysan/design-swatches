...
version: alpha
name: "1Password"
description: "Secure Airlock Behind Glass. A system that moves from the protective dark of an airlock to the bright clarity of a control room."
...
typography:
  display-hero:
    fontFamily: "agileSans, ui-sans-serif, system-ui, sans-serif"
    fontSize: 88px
    fontWeight: 400
    lineHeight: 1.05
    letterSpacing: -1px
