...
version: alpha
name: "The Verge"
description: "Acid mint headlines, 90px Manuka over black, ultraviolet focus rings, rave-flyer story tiles."
...
typography:
  display-hero:
    fontFamily: "Manuka, ui-sans-serif, system-ui, sans-serif"
    fontSize: 90px
    fontWeight: 900
    lineHeight: 1.05
    letterSpacing: -1px
