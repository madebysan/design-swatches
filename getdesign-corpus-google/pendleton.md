...
version: alpha
name: "Pendleton"
description: "Modesto slab display over Mukta body, deep navy hero block, ink-grey type on paper-cream surfaces, zero-radius rectangles."
...
typography:
  display-hero:
    fontFamily: "Modesto-Lite, ui-sans-serif, system-ui, sans-serif"
    fontSize: 48px
    fontWeight: 300
    lineHeight: 1.05
    letterSpacing: -1px
