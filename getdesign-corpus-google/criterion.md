...
description: "Near-black slate canvas, Mercury serif authority, and gold-ink restraint in service of cinema's greatest works"
...
typography:
  display-hero:
    fontFamily: "Mercury Text G1, ui-sans-serif, system-ui, sans-serif"
    fontSize: 96px
    fontWeight: 400
    lineHeight: 1.05
    letterSpacing: -1px
...
# The Criterion Collection Design System
