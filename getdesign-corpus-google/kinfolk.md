...
version: alpha
name: "Kinfolk"
description: "Transitional serif type on ink-ruled white canvas — slow-living editorial translated into digital stillness"
...
typography:
  display-hero:
    fontFamily: "Kinfolk-Serif-Deck, ui-sans-serif, system-ui, sans-serif"
    fontSize: 80px
    fontWeight: 400
    lineHeight: 1.05
    letterSpacing: -1px
