...
version: alpha
name: "Moleskine"
description: "Pencil-lead text on cream paper, signature warm orange CTA, composition-notebook chrome and a single typeface carrying every page"
...
typography:
  display-hero:
    fontFamily: "CustomJapFont, ui-sans-serif, system-ui, sans-serif"
    fontSize: 60px
    fontWeight: 500
    lineHeight: 1.05
    letterSpacing: -1px
