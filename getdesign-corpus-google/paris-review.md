...
description: "Heldane serif at 16-26px on bone-white paper, ivy-green accents, hand-set quarterly chrome built around the issue color"
...
typography:
  display-hero:
    fontFamily: "heldane, ui-sans-serif, system-ui, sans-serif"
    fontSize: 26px
    fontWeight: 400
    lineHeight: 1.05
    letterSpacing: -1px
...
# The Paris Review Design System
