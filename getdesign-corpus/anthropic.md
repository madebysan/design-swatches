...
category: AI
styles: [Light, Editorial, Gradient, Monochromatic]
tagline: "Research journal printed on warm stone — authoritative typographic composition where word-level underlines replace color as the primary emphasis mechanism, and the only warmth comes from the paper itself."
fonts: [Anthropic Sans, Anthropic Serif, Anthropic Mono]
primary_color: "#e3dacc"
---
...
![Anthropic](https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775930514139-thumb.jpg)
