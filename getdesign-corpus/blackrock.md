...
tagline: "Fort serif system at three weights, ink-black on white with a single ember-orange CTA accent, sharp 0px corners and 4px below-nav rule."
fonts: [FortExtraBold, FortBold, FortBook]
primary_color: "#ff4713"
---

# Design System Inspired by BlackRock

> Fort serif system at three weights, ink-black on white with a single ember-orange CTA accent, sharp 0px corners and 4px below-nav rule.
