...
domain: ubuntu.com
category: Dev Tools
styles: [Warm, Bold, Tactile]
tagline: "Fedora-aubergine masthead, warm orange CTAs, terminal-amber accents and the humanist Ubuntu typeface carrying every word"
fonts: [Ubuntu, Ubuntu Mono]
primary_color: "#E95420"
---

# Design System Inspired by Ubuntu

> Fedora-aubergine masthead, warm orange CTAs, terminal-amber accents and the humanist Ubuntu typeface carrying every word

*Note: dembrandt extraction failed for ubuntu.com (network connection reset blocked the live scrape). The values below are drawn from the publicly documented Vanilla Framework — Canonical's open-source design system that powers ubuntu.com — and Ubuntu's published brand assets. Where a value could not be confirmed against the live site in this session, it is marked `/* estimated */`.*
