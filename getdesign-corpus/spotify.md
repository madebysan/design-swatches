...
**Key Characteristics:**
- Near-black immersive canvas (`#000000`–`#1f1f1f`) as the dominant surface — the UI disappears behind content
- Spotify Green (`#1ed760`) as a tightly scoped accent — play controls, primary CTAs, active states, small badges, and at most a subtle green halo glow. Never a full background wash.
